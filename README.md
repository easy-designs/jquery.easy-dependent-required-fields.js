...
When a field becomes required, its `required` attribute is set and its label is given a "*" in the form of an abbreviation: `<abbr title="required">*</abbr>`. When the field is un-re